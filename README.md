...
A Python middleware script that captures the LLM's JSON output and validates it against the system's hardcoded medical vocabulary. This eliminates AI hallucinations by dropping any symptom not officially recognised by the Knowledge Base.
